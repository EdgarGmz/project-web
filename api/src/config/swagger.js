        ...
        schemas: {
            ...
            Product: {
                ...
                properties: {
                    ...
                    min_stock: { type: 'integer', description: 'Cantidad mínima de stock requerida', example: 5, minimum: 0 },
                    max_stock: { type: 'integer', description: 'Cantidad máxima de stock permitida', example: 100, minimum: 0 },
            ...
            Inventory: {
                ...
                properties: {
                    ...
                    stock_current: { type: 'integer', example: 25, minimum: 0 },
                    stock_minimum: { type: 'integer', example: 5, minimum: 0 },
